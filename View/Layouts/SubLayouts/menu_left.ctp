...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Main Page'), array('controller' => 'users', 'action' => 'index', 'admin' => false, 'manage' => false)); ?> </li>
		<li><?php echo $this->Html->link(__('Browse Categories'), array('controller' => 'users', 'action' => 'index', 'admin' => false, 'manage' => false)); ?> </li>
		<li><?php echo $this->Html->link(__('Community Portal'), array('controller' => 'users', 'action' => 'index', 'admin' => false, 'manage' => false)); ?> </li>
		<li><?php echo $this->Html->link(__('Recent Changes'), array('controller' => 'users', 'action' => 'index', 'admin' => false, 'manage' => false)); ?> </li>
		<li><?php echo $this->Html->link(__('Support'), array('controller' => 'users', 'action' => 'index', 'admin' => false, 'manage' => false)); ?> </li>
	</ul>
	...
	<?php if (AuthComponent::user('role_id') == 2 || AuthComponent::user('role_id') == 1) : ?>
		...
		<ul>
			<li><?php echo $this->Html->link(__('Article Revision Queue'), array('controller' => 'article_revisions', 'action' => 'index', 'admin' => false, 'manage' => true)); ?> </li>
			<li><?php echo $this->Html->link(__('Recent Comments'), array('controller' => 'comments', 'action' => 'index', 'admin' => false, 'manage' => true)); ?> </li>
		</ul>
	<?php endif; ?>
	...
	<ul>
		...
		<?php else : ?>
			<li><?php echo $this->Html->link(__('Account'), array('controller' => 'users', 'action' => 'edit', 'admin' => false, 'manage' => false)); ?> </li>
