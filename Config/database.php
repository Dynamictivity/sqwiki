...
class DATABASE_CONFIG
{
    ...
    {
        # Docker
        if (!empty(getenv('SQWIKI_DATABASE_HOST')) && !empty(getenv('SQWIKI_DATABASE_USERNAME'))
            && !empty(getenv('SQWIKI_DATABASE_PASSWORD')) && !empty(getenv('SQWIKI_DATABASE_DATABASE'))
        ) {
            $this->default = array(
                'datasource' => 'Database/Mysql',
                'persistent' => false,
                'host' => getenv('SQWIKI_DATABASE_HOST'),
